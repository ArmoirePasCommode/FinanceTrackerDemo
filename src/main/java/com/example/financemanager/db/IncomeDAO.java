...
public class IncomeDAO {
    ...
    public static ObservableList<Income> getIncome() {
    ...
    private static void fetchAllDataFromDB() {
        ...
        try (Connection connection = Database.connect()) {
            ...
            log.error("Could not load Income from database", e);
            incomes.clear();
        }
    }
    ...
    public static void insertIncome(Income income) {
        ...
        try (Connection connection = Database.connect()) {
            ...
            log.error("Could not insert Income in database", e);
        }
    ...
    public static List<Income> findLastIncomeEndingAtCurrentMonth(int numberOfLine, LocalDate currentMonth) {
        String query = "SELECT * FROM " + tableName
