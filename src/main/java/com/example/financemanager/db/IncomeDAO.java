...
public class IncomeDAO {
    ...
    private static final String selfEmploymentColumn = "selfEmployment";
        ...
        try (Connection connection = Database.connect()) {
            ...
            while (rs.next()) {
                incomes.add(new Income(
                        ...
                        rs.getFloat(selfEmploymentColumn),
    ...
    public static void insertIncome(Income income) {
        //update database
        String query = "INSERT INTO income(date, salary, aid, selfEmployment, passiveIncome) VALUES (?, ?, ?, ?, ?)";
        ...
        try (Connection connection = Database.connect()) {
            ...
            statement.setFloat(4, income.getSelfEmployment());
